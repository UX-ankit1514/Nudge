    ...
    >
      ...
      >
        ...
        >
          {/* Front Side */}
          <div
            className="absolute inset-0 w-full h-full rounded-[32px] overflow-hidden bg-[rgba(18,18,20,0.9)] backdrop-blur-[60px] border border-white/10 flex flex-col p-10 z-10 shadow-2xl transition-all duration-500"
            style={{ backfaceVisibility: 'hidden' }}
          >
            {/* Internal Radial Mesh */}
            <div
              className="absolute opacity-[0.3] pointer-events-none transition-opacity duration-500 group-hover:opacity-[0.5]"
              style={{
                inset: '-20%',
            ...
            {/* Main Hook Section */}
            <div className="flex flex-col items-start gap-6 w-full mt-14 relative z-20">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="font-body text-[14px] text-white/50 leading-relaxed max-w-[90%]">
            ...
            <div className="mt-auto flex items-center justify-between relative z-20">
              <button 
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all group/btn"
              >
                <span className="font-body font-medium text-[13px] text-[#d1fae5] group-hover/btn:text-white transition-colors">Try this</span>
                <ArrowRight size={16} className="text-white/40 group-hover/btn:text-white transition-all group-hover/btn:translate-x-0.5" />
              </button>
              ...
              <button 
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all group/btn"
              >
                <span className="font-body font-medium text-[13px] text-[#d1fae5] group-hover/btn:text-white transition-colors">Next</span>
                <ArrowRight size={16} className="text-white/40 group-hover/btn:text-white transition-all group-hover/btn:translate-x-0.5" />
              </button>
            </div>
          </div>
          ...
          {/* Back Side */}
          <div
            className="absolute inset-0 w-full h-full rounded-[32px] overflow-hidden bg-[rgba(18,18,20,0.95)] backdrop-blur-[60px] border border-white/10 flex flex-col p-10 z-10 shadow-2xl transition-all duration-500"
            style={{ 
          ...
          >
            ...
            {/* Strategy Content */}
            <div className="flex flex-col items-start gap-8 w-full mt-12 relative z-20">
              <p className="font-body font-semibold text-[21px] leading-tight text-white">
                 {card.back.strategy}
              </p>
              ...
              <div className="space-y-6 w-full">
                 <div className="space-y-2">
                    ...
                    <div className="font-body text-[14px] text-white/70 leading-relaxed space-y-1.5">
            ...
            <div className="mt-auto relative z-20">
               <p className="font-body font-light text-[12px] text-white/30 text-center w-full">
                  Tap to flip back
               </p>
            </div>
          </div>
